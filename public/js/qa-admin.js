/* ============================================
   qa-admin.js  --  QA Admin Dashboard Logic
   ============================================ */
(function () {
  "use strict";
  ...
  function renderStats(stats) {
    ...
    var html = '<div class="stats-section"><h3>依狀態分布</h3><div class="stats">';
    ...
    Object.entries(stats.byUnit).forEach(function (entry) {
    ...
    if (Object.keys(stats.byCategory).length > 0) {
      ...
      Object.entries(stats.byCategory).sort(function (a, b) { return b[1] - a[1]; }).forEach(function (entry) {
  ...
  // ── Search button ─────────────────────────────
  document.getElementById("btn-search").addEventListener("click", loadQuestions);
